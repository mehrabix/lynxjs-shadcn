    ...
    <view className={`min-h-screen ${darkMode ? 'dark bg-gray-900' : 'bg-white'}`}>
      <scroll-view className="flex flex-col items-center justify-start p-6 gap-8 h-screen" scroll-y={true}>
        ...
        <view className="flex flex-col gap-6 items-center w-full max-w-md">
          <text className={`text-2xl font-bold text-center ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>
            Welcome to Lynx UI
          </text>
          <text className={`text-lg text-center ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            A shadcn/ui-inspired component library built specifically for Lynx React applications
          </text>
        </view>
